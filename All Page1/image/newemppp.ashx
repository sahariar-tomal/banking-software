<%@ WebHandler Language="C#" Class="newemppp" %>
...
public class newemppp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select image from image_temp3 where eid='" + context.Request.QueryString["eid"] + "'";
