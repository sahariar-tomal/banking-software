<%@ WebHandler Language="C#" Class="fortranpp" %>
...
public class fortranpp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select picture from image_temp1 where AccountNumber='" + context.Request.QueryString["t_cid"] + "'";
