<%@ WebHandler Language="C#" Class="custsign" %>
...
public class custsign : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select signature from image_temp2 where AccountNumber='" + (context.Request.QueryString["cid"]).ToString() + "'";
