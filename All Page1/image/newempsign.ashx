<%@ WebHandler Language="C#" Class="newempsign" %>
...
public class newempsign : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select signature from image_temp4 where eid='" + context.Request.QueryString["eid"] + "'";
