<%@ WebHandler Language="C#" Class="fortransign" %>
...
public class fortransign : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select signature from image_temp2 where AccountNumber='" + context.Request.QueryString["t_cid"] + "'";
