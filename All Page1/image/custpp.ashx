<%@ WebHandler Language="C#" Class="custpp" %>
...
public class custpp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select picture from image_temp1 where AccountNumber='" + (context.Request.QueryString["cid"]).ToString()+"'";
