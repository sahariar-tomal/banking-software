<%@ WebHandler Language="C#" Class="viewemppp" %>
...
public class viewemppp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select image from image_temp3 where eid='" + context.Request.QueryString["sid"] + "'";
