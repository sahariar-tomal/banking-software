<%@ WebHandler Language="C#" Class="emppp" %>
...
public class emppp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string ImgString = "select image from image_temp3 where eid='" + context.Request.QueryString["id"] + "'";
