...
public partial class viewEmployee : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            try
            {
                ...
                Image1.ImageUrl = "image/viewemppp.ashx?sid=" + Convert.ToInt16(Session["sid"]);
            }
            catch (Exception ie)
            {
            ...
            query = "select * from Employee where eid='" + Session["sid"].ToString() + "'";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        OracleCommand cmd1 = new OracleCommand(upquery, connection);
