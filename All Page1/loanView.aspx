<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="loanView.aspx.cs" Inherits="LoanProfile" %>
        ...
        <table style="width: 100%; height: 71px;">
            ...
            <tr>
                <td class="style1">
                    Last Update</td>
                <td class="style5" style="width: 240px">
                    <asp:TextBox ID="LastUpdateTextBox" runat="server" Height="30px" Width="263px"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td class="style1">
                    Install amount</td>
                <td class="style5" style="width: 240px">
                    <asp:TextBox ID="InstallAmountTextBox" runat="server" Height="30px" 
            ...
            <tr>
                <td class="style1">
                    Paid amount</td>
                <td class="style5" style="width: 240px">
                    <asp:TextBox ID="PaidAmountTextBox" runat="server" Height="30px" Width="263px"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
